...
export const metadata = {
  ...
  description: 'Découvrez mes projets et réalisations en développement web et logiciel',
};
        ...
        <div className={styles.heroContainer}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.description}>
              Une sélection de mes projets personnels et professionnels démontrant mes compétences
              en développement.
            </p>
          </div>
        </div>
