      ...
      skills: [
        {
          name: "Git & GitHub",
          level: 85,
          icon: "logo_skills/GitHub.png",
          iconDark: "logo_skills/github-dark.svg",
        },
        { name: "Linux", level: 70, icon: "logo_skills/linux.png" },
        { name: "Windows", level: 70, icon: "logo_skills/Windows.png" },
        {
          name: "VS Code",
          level: 80,
          icon: "logo_skills/Visual_Studio_Code.png",
        },
        { name: "PHPStorm", level: 70, icon: "logo_skills/PhpStorm.png" },
        { name: "PyCharm", level: 70, icon: "logo_skills/PyCharm.png" },
        { name: "Oracle", level: 80, icon: "logo_skills/oracle.png" },
        {
          name: "MS Office",
          level: 90,
          icon: "logo_skills/Microsoft_Office.png",
        },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Gestion de projet", level: 80, icon: "" },
      ],
    },
  ];
